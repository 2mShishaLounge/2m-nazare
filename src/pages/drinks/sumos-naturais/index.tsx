...
// data
import { SumosNaturais as EN } from "menu-en";
import { SumosNaturais as PT } from "menu-pt";
import { SumosNaturais as ES } from "menu-es";
import { SumosNaturais as FR } from "menu-fr";
import { useRouter } from "next/router";
import { type MenuItem } from "../aguas";
import { getDisclaimerByLocale } from "~/utils/getLocale";

const NaturalJuiceOptions = () => {
...
export default NaturalJuiceOptions;
