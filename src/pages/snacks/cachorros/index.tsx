...
// data
import { Cachorros as EN } from "menu-en";
import { Cachorros as PT } from "menu-pt";
import { Cachorros as ES } from "menu-es";
import { Cachorros as FR } from "menu-fr";
import { useRouter } from "next/router";
import { type MenuItem } from "~/pages/drinks/aguas";
import { getDisclaimerByLocale } from "~/utils/getLocale";

const HotDogsOptions = () => {
