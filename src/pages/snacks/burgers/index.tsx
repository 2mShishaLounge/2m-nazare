...
// data
import { Burgers as EN } from "menu-en";
import { Burgers as PT } from "menu-pt";
import { Burgers as ES } from "menu-es";
import { Burgers as FR } from "menu-fr";
import { useRouter } from "next/router";
import { type MenuItem } from "~/pages/drinks/aguas";
import { getDisclaimerByLocale } from "~/utils/getLocale";

const BurguersOptions = () => {
...
export default BurguersOptions;
